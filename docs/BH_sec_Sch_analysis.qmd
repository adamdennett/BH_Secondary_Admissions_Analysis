...
#                           origins = bh_sec_sch,
#                           destinations = brighton_oa_points_r5,
#                           mode = mode,
...
# geo = inner_join(brighton_oa_points_r5, ttm, by=c(id = "to_id"))
# head(geo)
```
...
head(ttm_brighton_h3)
nrow(ttm_brighton_h3)
summary(ttm_brighton_h3)
