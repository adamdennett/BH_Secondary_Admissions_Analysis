...
Given that under option 2, there is a high probability that singificant numbers of pupils from Central Brighton would be forced to attend Longhill, this is a significant issue.
...
1.  It is undeniable Brighton and Hove faces challenges of a declining school roll which put pressures on

2.  The proposals to reduce PANs in schools across the city appear to be based on a desire to reduce the number of places in schools in areas of the city where demand is already high relative to the number of places available. This is a social engineering approach which will likely lead to children being forced to travel across the city to attend schools in catchments where demand is lower relative to the number of places available. This is likely to lead to increased traffic congestion and pollution across the city, as well as increased costs to the council in providing free bus transport to children who will be forced to travel long distances to school.
